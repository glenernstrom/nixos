...
;              
CREATE USER IF NOT EXISTS "SA" SALT '52a07d528e391091' HASH '0e784336524f7126a35e36d7eb1a5e79ed63e735cddcd9b553d8561491d3ca29' ADMIN;          
...
INSERT INTO "PUBLIC"."USERS"("USER_ID", "API_KEY", "AUTHENTICATIONTYPE", "ENABLED", "IS_FIRST_LOGIN", "PASSWORD", "ROLE_NAME", "USERNAME", "TEAM_ID") VALUES(1, NULL, 'web', TRUE, TRUE, '$2a$10$NWUj7DFGYhys2thsH8Ygq.NEFRos9TDKgDr5vOQ5.23RoHXl2u72i', NULL, 'admin', 1);    
INSERT INTO "PUBLIC"."USERS"("USER_ID", "API_KEY", "AUTHENTICATIONTYPE", "ENABLED", "IS_FIRST_LOGIN", "PASSWORD", "ROLE_NAME", "USERNAME", "TEAM_ID") VALUES(2, 'b029b752-6b73-4878-b7eb-93c193ddeb84', 'web', TRUE, FALSE, '$2a$10$jxALGY4vzFl08xuBBiv6GuGySrYga7f3cCcH0lSa4Gr7TKv4fWUR.', NULL, 'STIRLING-PDF-BACKEND-API-USER', 2);         
